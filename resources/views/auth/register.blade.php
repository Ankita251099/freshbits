                ...
                <div class="admin-form theme-system mtn" id="login1">
                    ...
                    <div class="panel panel-system mt10 br-n">
                        <div class="panel-heading heading-border bg-white p15 pt20">
                            <h2 class='text-system mn' style='font-weight:500;'><i class='fa fa-user'></i> Sign Up</h2>
                        </div>
                        ...
                        <form method="post" action="{{ route('user-register') }}">
                            ...
                            <div class="panel-body bg-light p15">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="section mb10">
                                            <label for="password-confirm" class="field-label text-muted fs18 mb10">{{ __('Confirm Password') }}</label>
                            ...
                            <div class="panel-footer clearfix p10 ph15">
                                <button type="submit" class="button btn btn-success mr10 pull-right">
                                    {{ __('Register') }}
                                </button>
